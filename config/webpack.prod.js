    ...
    plugins: [
      ...
      new DefinePlugin({
        ...
        'process.env': {
          ...
          'HMR': METADATA.HMR,
            'VERSION': JSON.stringify(versionObj.version),
            'AIRLOCK_API_URL': JSON.stringify((process.env.AIRLOCK_API_URL) ?
                process.env.AIRLOCK_API_URL : ((process.env.airlock_api_url) ?
                    process.env.airlock_api_url : 'http://9.148.54.98:7070/airlock/api/admin')),
            'AIR_LOCK_DEBUG_URL': JSON.stringify(process.env.AIRLOCK_API_URL),
            'AIR_LOCK_DEBUG_URL2': process.env.AIRLOCK_API_URL,
            'AIRLOCK_API_AUTH': JSON.stringify((process.env.AIRLOCK_API_AUTH) ?
      ...
      process.env.AIRLOCK_API_AUTH_KEY : 'blueidSSL'),
      'AIRLOCK_AUTH_AZURE_URL': JSON.stringify((process.env.AIRLOCK_AUTH_AZURE_URL) ?
      process.env.AIRLOCK_AUTH_AZURE_URL : 'https://analytics1.airlock.twcmobile.weather.com'),
          'AIRLOCK_ANALYTICS_URL': JSON.stringify((process.env.AIRLOCK_ANALYTICS_URL) ?
