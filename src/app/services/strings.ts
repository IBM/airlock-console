...
`,
        ...
        add_question_name: `
Enter a short question name.
Names can contain English letters, digits, spaces, and periods only.
The name must start with a letter.
`,
        add_question_name_title: "",
...
`,
        ...
        show_job_title: "User Attribute Import Job",
        show_job_status_tab_heading: "Status",
        edit_cohort_query_tab_heading: "Query",
        edit_cohort_status_tab_heading: "Status",
        edit_cohort_export_tab_heading: "Exports",
        edit_cohort_alert: "Are you sure you want to update this cohort?",
        edit_cohort_title: "Edit Cohort",
        edit_cohort_name: "The name of the cohort",
        edit_cohort_number_of_users: "",
        edit_cohort_export_name: `
Export Names can contain English letters, digits, spaces, and periods only.
The name must start with a letter. Export Name should start with the prefix "air" to avoid overriding existing attributes 
`,
        edit_cohort_update_frequency: "Choose the frequency in which the cohort will recalculate. Manual means it won’t recalculate automatically",
        edit_cohort_query_tab_details: "The Query Condition is the WHERE clause of the SQL query that defines users in the cohorts. Use the Value Expression to assign a dynamic value for each user in the cohort (provided as an SQL value expression in PostgreSQL syntax).",
        edit_cohort_value_expression_details: "The Value Expression is added to the SELECT part of the SQL query.",
        edit_cohort_export_explain: "In order to sync the cohort with external systems you should define the user attribute name and keep track of the export status",
        empty_title: "",
        edit_variant_name: "",
        ...
        add_job_s3path_details: "Enter valid AWS S3 file path to a CSV formatted user attributes file",
        add_job_s3path_learn_more: "Learn more...",
...
`,
        reorder_cohorts_subheader: `Cohorts order is purely for display preferences and has no affect on the back-end`,
...
`,
        ...
        edit_input_schema_title: "Edit Context Schema",
        ...
        edit_change_production_poll: "Are you sure you want to change this poll in production?",
        ...
        add_cohort_name: "Choose a name for the cohort",
        add_cohort_name_title: "",
        add_cohort_query_condition: "The query will define the users in the cohort",
        add_cohort_query_condition_title: "",
        add_cohort_export_type: "Choose the type of 3rd party to export the cohort to",
        streams_header_text: "",
...
`,
        ...
        edit_streams_data_title: "Stream History Collection Settings",
        edit_streams_data_subtitle: "Enabling History allows the device to retain events that future streams could process retroactively",
        edit_streams_data_save_warning: "Changing history collection values might have unexpected and unrecoverable consequences. Are you sure?",
        edit_streams_data_filter_edit_title: "Filter",
        edit_streams_data_enable_historical_events: "Enable Historical Events",
        edit_streams_data_enable_historical_events_title: "",
        edit_streams_data_enable_historical_events_tooltip: "Check this option to allow streams to use past events",
        edit_streams_data_days_to_keep: "Days to keep history",
        edit_streams_data_days_to_keep_title: "",
        edit_streams_data_days_to_keep_tooltip: "Maximum days of historical events that the device will store",
        edit_streams_data_bulk_size: "Bulk Size (in files)",
        edit_streams_data_bulk_size_title: "",
        edit_streams_data_bulk_size_tooltip: "How many files will be processed at a time",
        edit_streams_max_totle_size: "Maximum total size (KB)",
        edit_streams_max_totle_size_title: "",
        edit_streams_max_totle_size_tooltip: "The maximum total size (in KB) of history events in memory",
        edit_streams_history_file_max: "Maximum history file size (KB)",
        edit_streams_history_file_max_title: "",
        edit_streams_history_file_max_tooltip: "The maximum total size (in KB) of history file stored on the device",
        edit_streams_history_buffer_size: "History Buffer size (KB)",
        edit_streams_history_buffer_size_title: "",
        edit_streams_history_buffer_size_tooltip: "Size before writing to file",
        edit_streams_data_filter_tab_details: "Set conditions in JavaScript that determine which events will be retained to history",
        ...
        edit_stream_operate_on_history: "Process historical events",
        edit_stream_operate_on_history_tooltip: "Allow this stream to access events prior to it's creation",
        edit_stream_operate_on_history_title: "",
        edit_stream_limit_historical_events: "Limit historical events",
        edit_stream_limit_historical_events_tooltip: "Limit the days of historical events to process",
        edit_stream_limit_historical_events_title: "",
...
`,
        ...
        poll_cell_questions_title: "Questions: The following questions belong to the poll.",
        edit_question_answers_tab_heading: "Answers",
        edit_change_production_question: "Are you sure you want to change this question in production?",
        reorder_questions_subheader: `Arrange questions in descending order of preference.`,

        edit_question_title: "Title is the question text to be shown to user",
        edit_question_screen_title: "Edit Question",
        edit_answer_title: "Title is the answer text to be shown to user",
        add_poll_title: `The poll title is used for documentation purposes only`,
        edit_poll_min_app_version: "The minimum version of the app for which this poll is tested and should be enabled.",
        edit_poll_max_app_version: "The maximum version of the app for which this poll is tested and should be enabled.",
        edit_poll_rollout: "The percentage of users who will see this poll. You can enter a value with up to 4 decimal places.",
        edit_question_rollout: "The percentage of users who will see this question. You can enter a value with up to 4 decimal places.",
        add_poll_group: "The poll will be visible to the internal user groups specified here.",
        add_question_group: "The question will be visible to the internal user groups specified here.",
        limit_polls_subheader: `Limit the total number of polls on the device.`,
        edit_question_id: `
Id's can contain English letters, digits, spaces, and periods only.
The name must start with a letter.
`,
        edit_question_dynamic_title: "title to be used using dynamic variants",
        edit_answer_data_type: "The answer datatype could be one of the drop down values",
        edit_question_user_attribute: "Question additional user attribute",
        edit_question_max_answers: "Max answers permitted for this question",
        edit_question_vis_add_markup: "Question visualization markup",
        edit_question_vis_type: "Question visualization type - could be one on the dropdown values",
        edit_question_shuffle_answers: "Should question shuffle answers",
        edit_question_multiple_answers: "Defines if question can have multiple answers",
        edit_question_pi: "Does this question contain private information",
        edit_question_trivia_style: "Defines if this question has a correct answer",
        edit_answer_dynamic_title: "title to be used using dynamic variants",
        edit_answer_goto: "Define the next question to goto after this answer",
        edit_answer_correct: "Defines if this answer is the correct answer",


        // edit_question_title: "Question title"
};
