...
@Component({
    ...
    styleUrls: ['./addFeatureToGroupModal.scss'],
    templateUrl: './addFeatureToGroupModal.html',
...
export class AddFeatureToGroupModal {
    ...
    constructor(private _airLockService: AirlockService,
                ...
                public _featureUtils: FeatureUtilsService,
                private toastrService: NbToastrService,
                private modalRef: NbDialogRef<AddFeatureToGroupModal>) {
    ...
    create(message: string) {
        this.toastrService.danger(message, "Failed to add to group/feature.", {
            duration: 60000,
