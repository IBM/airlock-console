...
import "select2";
import {FeatureUtilsService, FeatureInFlatList, InAppPurchaseInFlatList} from "../../../services/featureUtils.service";
...
@Component({
    ...
    styles: [require('./editPurchaseModal.scss'),require('select2/dist/css/select2.css')],

    template: require('./editPurchaseModal.html'),
...
export class EditPurchaseModal{
                ...
                if(this.feature.stage == 'PRODUCTION'){
                    ...
                    if(this.isOrderRule()){
                        ...
                        if(this.isConfigMode()){
                            ...
                            this.verifyActionModal.open(this._stringsSrevice.getString("edit_change_production_entitlement"), this.feature, VeryfyDialogType.ENTITELMENT_TYPE);
                        }
                    }
                }else {
                    this._save();
    ...
    open(branch: Branch, feature: InAppPurchase, featurePath: Array<InAppPurchase>, strInputSchemaSample:string, strUtilitiesInfo:string, featureCell: PurchaseCell = null,
