...
@Component({
    ...
    selector: 'hirarchy-node',
    styles: [require('./hirarchyNode.scss')],
    ...
    template: require('./hirarchyNode.html'),

    changeDetection: ChangeDetectionStrategy.OnPush
})
export class HirarchyNode {
    @ViewChild('noderef') noderef: ElementRef;
    @Input() feature:Feature;
    @Input() featurePath:Array<Feature>;
    @Input() targetFeature: Feature;
    @Input() currentFather: Feature;
    ...
    getChildren() {
        if (this.featureType == 'ENTITLEMENT') {
            ...
            let option = this.feature as PurchaseOptions;
            return option.purchaseOptions;
        } else {
