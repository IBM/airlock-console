...
@Component({
    ...
    styles: [require('./style.scss'),require('./purchaseOptionsCell.scss'),require('./dnd.scss')],
    ...
    template: require('./purchaseOptionsCell.html'),
...
export class PurchaseOptionsCell {
    ...
    @Input() addFeatureModal:AddPurchaseOptionModal;
    ...
    getMXTitle() : string {
        console.log("PurchaseOptions getMXTitle");
        ...
        if (f.isCurrentUserFollower){
            ...
            this._airlockService.unfollowFeature(f.uniqueId)
                .then(response  => {
                    ...
                    this._airlockService.notifyDataChanged("success-notification",{title:"Success",message:this.getStringWithFormat("notifications_unfollow_purchase_option_success",f.name)});
                })
                .catch(error => {
                    this._featuresPage.loading = false;
            ...
            this._airlockService.followFeature(f.uniqueId)
                .then(response  => {
                    ...
                    this.onUpdate.emit(f);
                    this._featuresPage.loading = false;
                    this._airlockService.notifyDataChanged("success-notification",{title:"Success",message:this.getStringWithFormat("notifications_follow_purchase_option_success",f.name)});
                })
                .catch(error => {
                    this._featuresPage.loading = false;
    ...
    addFeatureToMXGroup() {
        ...
        this._airlockService.getFeature(this.parentFeatureId, this.branch.uniqueId).then(parent => {
            ...
            this.addToMXGroupModal.open(this.branch, this.feature, parentFeature,false,false,true);
        });
    ...
    openEditDialog(event){
        ...
        if (this.ruleUtilitieInfo!=null && this.ruleInputSchemaSample!= null) {
            ...
            this._airlockService.getInAppPurchases(this.branch.seasonId, this.branch).then(purchasesResult => {
                ...
                this.editPurchaseOptionsModal.open(this.branch, this.feature, this.parentFeatureId, this.featuresPath, this.ruleInputSchemaSample, this.ruleUtilitieInfo,this,null,false,null, null, []);
            }).catch(error => {
    ...
    openAddConfigurationDialog() {
        ...
        // this.addConfigurationModal.openAsAddSubFeature(this.branch.uniqueId, this.feature.uniqueId, this.feature.name, this.feature.namespace,true,false,this.feature.type);
    }
    ...
    shouldShowConfig(): boolean {
        ...
        console.log("shouldShowConfig:"+this.feature.name);
        ...
        // }
        return (showConfig && ((this.getConfigs() && this.getConfigs().length > 0) || (this.feature.defaultConfiguration && (this.feature.defaultConfiguration !== {} && this.feature.defaultConfiguration !== "{}"))));
    }
        ...
        if (feature.type === "PURCHASE_OPTIONS_MUTUAL_EXCLUSION_GROUP" || feature.type === "PURCHASE_OPTIONS") {
            ...
            if(option.purchaseOptions) {
                for (var subOption of option.purchaseOptions) {
                    console.log("XXXXXX search in orderingRules:" + subOption.name);
    ...
    changeStage() {
        ...
        this.verifyActionModal.open(message,this.feature, VeryfyDialogType.PURCHASE_OPTION_TYPE, this.confirmSubfeatureStageChange);
    ...
    _changeStage() {
        ...
        this._airlockService.updatePurchaseOptions(newStageFeature, this.branch.uniqueId).then(feature => {
            ...
            this.onUpdate.emit(this.feature);
            this._airlockService.notifyDataChanged("success-notification",{title:"Success",message:"Purchase option stage changed successfully"});
        }).catch(error => {
    ...
    getPurchaseOptions() {
        console.log("getPurchaseOptions:" + this.feature.name)
        console.log((this.feature as PurchaseOptions).purchaseOptions);
        return (this.feature as PurchaseOptions).purchaseOptions;
    ...
    promptChangeSendToAnalytics() {
        ...
        if (this.feature.stage=='PRODUCTION') {
            ...
            this.verifyActionModal.open(message,this.feature, VeryfyDialogType.PURCHASE_OPTION_TYPE);
        } else {
            this.modal.confirm()
                .title(message)
                .open()
